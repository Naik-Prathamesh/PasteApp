    ...
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        ...
        <div className="flex flex-col border border-[rgba(128,121,121,0.3)] py-4 rounded-[0.4rem]">
          <h2 className="px-4 text-4xl font-bold font-sans border-b border-[rgba(128,121,121,0.3)] pb-4">
            All Pastes
          </h2>
              ...
              filteredPastes.map((paste) => (
                ...
                >
                  ...
                  <div className="w-[50%] flex flex-col space-y-3">
                    <p className="text-4xl font-semibold font-sans ">{paste?.title}</p>
                    <p className="text-sm font-normal font-sans line-clamp-3 max-w-[80%] text-[#707070]">
                      {paste?.content}
                    </p>
                  </div>
